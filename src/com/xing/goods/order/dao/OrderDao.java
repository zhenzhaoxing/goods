package com.xing.goods.order.dao;
/*
 * **
 * 用户模块持久层 与数据库打交道
 * @author qdmmy6
...
public class OrderDao {
	 ...
	 * 
	 * **/
	public void updateStaus(String oid,int status) throws SQLException{
	...
	private PageBean<Order> findByCriteria(List<Expression> exprList, int pc) throws SQLException {
		...
		//order=1  bean=.. oeder=2 bean=.. 一直持续下去  最后得到所有 beanlist 返回iu
		
		//uid  下面有 oid1 oid2 oid3
	...
	private List<OrderItem> toOrderItemList(List<Map<String, Object>> mapList) {
		List<OrderItem> orderItemList = new ArrayList<OrderItem>();//空集合
		//遍历多个订单
