package com.xing.goods.book.domain;
...
public String toString() {
	return "Book [bid=" + bid + ", bname=" + bname + ", author=" + author + ", price=" + price + ", currPrice="
			...
			+ booksize + ", paper=" + paper + ", category=" + category + ", image_w=" + image_w + ", image_b=" + image_b
			+ "]";
}
...
private Category category;//所属分类 关联的外键
...
public void de(){
	...
	System.out.println(b.category.getCid());	
}
